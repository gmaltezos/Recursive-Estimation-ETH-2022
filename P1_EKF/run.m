function [trackErrorNorm,angularErrorNorm,velocityErrorNorm,windErrorNorm,biasErrorNorm,initialEst,initialVar, tEstAvg]=run(simConst,estConst,doplot,seed)
%
%
